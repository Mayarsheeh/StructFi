...
AUTH_SECRET_KEY = os.getenv(
    ...
    "CHANGE_THIS_STRUCTFI_DEMO_SECRET_KEY_BEFORE_PRODUCTION",
)
...
# -------------------------------------------------------------------
# Demo Tenant/User Store
# Later we can replace this with a real database.
# -------------------------------------------------------------------

_DEFAULT_ADMIN_PASSWORD = os.getenv("STRUCTFI_DEMO_ADMIN_PASSWORD", "StructFi@123")
_DEFAULT_MANAGER_PASSWORD = os.getenv("STRUCTFI_DEMO_MANAGER_PASSWORD", "Manager@123")

_ADMIN_SALT = os.getenv("STRUCTFI_DEMO_ADMIN_SALT", "structfi-admin-salt")
_MANAGER_SALT = os.getenv("STRUCTFI_DEMO_MANAGER_SALT", "structfi-manager-salt")
...
_USERS: Dict[str, Dict[str, Any]] = {
    "admin@structfi.local": {
        ...
        "role": "admin",
        "organization_id": 1,
        "organization_name": "StructFi Demo Company",
        "project_id": 1,
    ...
    "manager@company.local": {
        ...
        "project_id": 2,
        "project_name": "Client Main Building",
